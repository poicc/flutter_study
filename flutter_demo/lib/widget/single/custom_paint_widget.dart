...
class _CustomPaintWidgetState extends State<CustomPaintWidget> {
  ...
  void initState() {
    super.initState();
    load("images/avatar1.png").then((i) {
      setState(() {
        _image = i;
      });
    });
...
/// pi:圆周率，表示180度。
/// 界面尺寸单位是像素
/// CustomPainter展示的是静态时点的静态⻚面，如果想要实现动态效果(如动画，手势)需要通过setState更新
...
class BasicPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // 绘制⻉塞尔曲线
    // cubicTo(double x1, double y1, double x2, double y2, double x3, doubley3)
